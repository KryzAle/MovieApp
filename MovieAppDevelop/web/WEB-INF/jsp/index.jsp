...
<html lang="en">
    <head>
        ...
        <link rel="icon" href="recursos/img/fav-icon.png" type="image/x-icon" />
        <!-- The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags -->
        <title>Drimo - App Landing Page Template</title>

        <!-- Icon css link -->
        <link href="recursos/css/font-awesome.min.css" rel="stylesheet">
        <link href="recursos/css/icofont.css" rel="stylesheet">
        
        <!-- Bootstrap -->
        <link href="recursos/css/bootstrap.min.css" rel="stylesheet">
        
        <!-- Rev slider css -->
        <link href="recursos/vendors/revolution/css/settings.css" rel="stylesheet">
        <link href="recursos/vendors/revolution/css/layers.css" rel="stylesheet">
        <link href="recursos/vendors/revolution/css/navigation.css" rel="stylesheet">
        <link href="recursos/vendors/animate-css/animate.css" rel="stylesheet">
        
        <!-- Extra plugin css -->
        <link href="recursos/vendors/magnific-popup/magnific-popup.css" rel="stylesheet">
        <link href="recursos/vendors/owl-carousel/assets/owl.carousel.min.css" rel="stylesheet">
            ...
            <div class="main_menu_area">
                <div class="container">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#"><img src="recursos/img/logo.png" alt=""></a>
                    </div>
                ...
                <div class="row app_feature_inner">
                    ...
                    <div class="col-md-6">
                        <div class="app_round_image">
                            <img class="round_c" src="recursos/img/round-circle.png" alt="">
                            <img class="app_mobile" src="recursos/img/app-mobile.png" alt="">
                        </div>
        ...
        <section class="choose_us_area">
            <div class="col-md-6">
                <div class="row left_choose_image">
                    <ul>
                        <li><img src="recursos/img/mockup-img/m-image-1.png" alt=""></li>
                        <li><img src="recursos/img/mockup-img/m-image-2.png" alt="" data-parallax='{"x": 25, "y": -50}'></li>
                        <li><img src="recursos/img/mockup-img/m-image-3.png" alt="" data-parallax='{"x": 50, "y": -100}'></li>
                        <li><img src="recursos/img/mockup-img/m-image-4.png" alt="" data-parallax='{"x": 90, "y": -180}'></li>
                        <li><img src="recursos/img/mockup-img/m-image-5.png" alt="" data-parallax='{"x": 20, "y": -30}'></li>
                        <li><img src="recursos/img/mockup-img/m-image-6.png" alt="" data-parallax='{"x": 90, "y": -100}'></li>
                        <li><img src="recursos/img/mockup-img/m-image-7.png" alt=""></li>
                        <li><img src="recursos/img/mockup-img/m-image-8.png" alt="" data-parallax='{"x": 90, "y": -180}'></li>
                    </ul>
                </div>
            </div>
            <div class="col-md-6">
        ...
        <section class="video_area">
            <div class="container">
                <div class="video_inner">
                    <img src="recursos/img/video-img.png" alt="">
                ...
                <div class="user_slider_inner">
                    <div class="user_slider owl-carousel">
                        <div class="item">
                            ...
                            <img class="img-circle" src="recursos/img/user/user-1.png" alt="">
                        </div>
                        <div class="item">
                            <i class="fa fa-quote-left" aria-hidden="true"></i>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
            ...
            <div class="col-md-6">
                <div class="row">
                    <div class="install_mockup_img">
                        <img src="recursos/img/macbook-res.png" alt="">
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                ...
                <div class="app_screen_inner">
                    <div class="app_screen_slider owl-carousel">
                        <div class="item"><img src="recursos/img/screenshot/screenshot-1.jpg" alt=""></div>
                        <div class="item"><img src="recursos/img/screenshot/screenshot-2.jpg" alt=""></div>
                        <div class="item"><img src="recursos/img/screenshot/screenshot-3.jpg" alt=""></div>
                        <div class="item"><img src="recursos/img/screenshot/screenshot-1.jpg" alt=""></div>
                        <div class="item"><img src="recursos/img/screenshot/screenshot-2.jpg" alt=""></div>
                        <div class="item"><img src="recursos/img/screenshot/screenshot-3.jpg" alt=""></div>
                        <div class="item"><img src="recursos/img/screenshot/screenshot-1.jpg" alt=""></div>
                ...
                <div class="team_slider owl-carousel">
                    <div class="item">
                        <div class="team_slider_item">
                            <img src="recursos/img/team-slider/team-1.jpg" alt="">
                    ...
                    <div class="item">
                        <div class="team_slider_item">
                            <img src="recursos/img/team-slider/team-2.jpg" alt="">
                            <div class="team_hover">
                                <div class="team_hover_inner">
                                    <div class="team_hover_inner">
                                        <div class="team_inner_text">
                    ...
                    <div class="item">
                        <div class="team_slider_item">
                            <img src="recursos/img/team-slider/team-3.jpg" alt="">
                            <div class="team_hover">
                                <div class="team_hover_inner">
                                    <div class="team_hover_inner">
                                        <div class="team_inner_text">
                    ...
                    <div class="item">
                        <div class="team_slider_item">
                            <img src="recursos/img/team-slider/team-4.jpg" alt="">
                            <div class="team_hover">
                                <div class="team_hover_inner">
                                    <div class="team_hover_inner">
                                        <div class="team_inner_text">
                ...
                <div class="row">
                    ...
                    <div class="col-md-5">
                        <div class="right_question_img">
                            <img src="recursos/img/question-tab.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row latest_blog_inner">
                        ...
                        <div class="l_blog_big_item">
                            <div class="l_blog_img">
                                <div class="l_blog_slider owl-carousel">
                                    <div class="item">
                                        <img src="recursos/img/blog/l-blog/l-blog-1.jpg" alt="">
                                    </div>
                                    <div class="item">
                                        <img src="recursos/img/blog/l-blog/l-blog-1.jpg" alt="">
                                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="right_l_blog">
                            <div class="media">
                                <div class="media-left">
                                    <img src="recursos/img/blog/l-blog/l-blog-2.jpg" alt="">
                                </div>
                                <div class="media-body">
                            ...
                            <div class="media">
                                <div class="media-left">
                                    <img src="recursos/img/blog/l-blog/l-blog-3.jpg" alt="">
                                </div>
                                <div class="media-body">
                                    <a href="#"><h4>On Graphics Design Post</h4></a>
                                    <a href="#"><h5><i class="fa fa-calendar" aria-hidden="true"></i>16 JUNE 2016</h5></a>
                            ...
                            <div class="media">
                                <div class="media-left">
                                    <img src="recursos/img/blog/l-blog/l-blog-4.jpg" alt="">
                                </div>
                                <div class="media-body">
                                    <a href="#"><h4>On Graphics Design Post</h4></a>
                                    <a href="#"><h5><i class="fa fa-calendar" aria-hidden="true"></i>16 JUNE 2016</h5></a>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
        ...
        <script src="recursos/js/jquery-2.2.4.js"></script>
        <!-- Include all compiled plugins (below), or include individual files as needed -->
        <script src="recursos/js/bootstrap.min.js"></script>
        <!-- Rev slider js -->
        <script src="recursos/vendors/revolution/js/jquery.themepunch.tools.min.js"></script>
        <script src="recursos/vendors/revolution/js/jquery.themepunch.revolution.min.js"></script>
        <script src="recursos/vendors/revolution/js/extensions/revolution.extension.video.min.js"></script>
        <script src="recursos/vendors/revolution/js/extensions/revolution.extension.slideanims.min.js"></script>
        <script src="recursos/vendors/revolution/js/extensions/revolution.extension.layeranimation.min.js"></script>
        <script src="recursos/vendors/revolution/js/extensions/revolution.extension.navigation.min.js"></script>
        <!-- Extra Plugin -->
        <script src="recursos/vendors/parallax/jquery.parallax-scroll.js"></script>
        <script src="recursos/vendors/magnific-popup/jquery.magnific-popup.min.js"></script>
        <script src="recursos/vendors/owl-carousel/owl.carousel.min.js"></script>
        <script src="recursos/vendors/counterup/waypoints.min.js"></script>
        <script src="recursos/vendors/counterup/jquery.counterup.min.js"></script>
        <script src="recursos/vendors/flexslider/flex-slider.js"></script>
        <script src="recursos/vendors/flexslider/mixitup.js"></script>
        <script src="recursos/vendors/swiper/js/swiper.min.js"></script>
        <script src="recursos/vendors/flipster-slider/jquery.flipster.min.js"></script>
        <script src="recursos/vendors/nice-selector/jquery.nice-select.min.js"></script>
